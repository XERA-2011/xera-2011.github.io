import { copyGrid, getColor, isInside, setColorEmpty } from "../types/grid";
import { around4 } from "../types/point";
...
import { isOutside } from "@/lib/snake/solver/outside";
import { trimTunnelEnd, trimTunnelStart } from "./tunnel";
import type { Outside } from "@/lib/snake/solver/outside";
import type { Snake } from "../types/snake";
import type { Empty, Color, Grid } from "../types/grid";

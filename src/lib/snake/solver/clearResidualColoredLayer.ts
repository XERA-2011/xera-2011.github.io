...
import { getHeadX, getHeadY, getSnakeLength } from "../types/snake";
import { getBestTunnel } from "./getBestTunnel";
import { fillOutside, Outside } from "@/lib/snake/solver/outside";
import { getTunnelPath } from "./tunnel";
import { getPathTo } from "@/lib/snake/solver/getPathTo";
import type { Snake } from "../types/snake";
import type { Color, Grid } from "../types/grid";

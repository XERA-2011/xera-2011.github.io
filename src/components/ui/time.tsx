      ...
      >
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="relative">
            <motion.span
              className="text-6xl sm:text-7xl lg:text-8xl font-bold bg-linear-to-b from-foreground to-foreground/70 bg-clip-text text-transparent tabular-nums"
          ...
          <div className="relative">
            <motion.span
              className="text-6xl sm:text-7xl lg:text-8xl font-bold bg-linear-to-b from-foreground via-foreground/90 to-foreground/70 bg-clip-text text-transparent tabular-nums"

...
- [Texas Hold'em (单机德州扑克)](src/app/games/texas-holdem) - A robust single-player Texas Hold'em poker game implemented with Next.js and React. Features AI opponents with distinct personas, game log, and smooth animations. 纯前端实现的单机版德州扑克游戏。
